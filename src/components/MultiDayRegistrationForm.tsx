...
import { MealType, View, Role } from '../types';
...
const MultiDayRegistrationForm: React.FC<{ setView: (view: View) => void }> = ({ setView }) => {
  ...
  const {
      ...
      handlers,
      groupedConfirmation,
  } = useMultiDayRegistrationForm({ setView, setActiveDate });
